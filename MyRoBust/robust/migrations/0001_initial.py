# Generated by Django 3.1.1 on 2020-12-02 04:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='robust.driver')),
            ],
            options={
                'db_table': 'Bus',
            },
        ...
        migrations.CreateModel(
            name='Booking',
            fields=[
                ('booking', models.AutoField(default=1, primary_key=True, serialize=False)),
