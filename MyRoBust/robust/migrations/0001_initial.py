# Generated by Django 3.1.1 on 2020-12-02 02:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Booking',
            fields=[
                ('bus_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='robust.bus')),
                ('seatNumber', models.CharField(max_length=15)),
                ('BusID', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bookingBusID', to='robust.bus')),
            ],
            options={
                'db_table': 'Booking',
            },
